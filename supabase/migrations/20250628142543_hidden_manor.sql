/*
  # Insert sample products for GiftHarmony

  1. Sample Data
    - Insert sample products across different categories
    - Include realistic Vietnamese product data
    - Set appropriate pricing and stock levels
...
BEGIN
  ...
  -- Insert Làm đẹp products (fixed column count)
